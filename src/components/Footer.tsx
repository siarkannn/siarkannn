...
export function Footer({ className = "", isAboutPage = false, isArtistPage = false, isWorkPage = false }: FooterProps = {}) {
  const topPaddingMobile = isAboutPage
    ? "pt-[87px] min-[390px]:pt-[89px]"
    : "pt-[86px] min-[390px]:pt-[88px]";
  const bottomPaddingMobile = "pb-[16px] min-[390px]:pb-[18px]";
  ...
  const contentTranslateMobile = "-translate-y-[28px] min-[360px]:-translate-y-[29px] min-[390px]:-translate-y-[30px] min-[414px]:-translate-y-[31px]";
