...
export function About() {
  return (
    <>
      <section
        id="about"
        className="relative w-full min-h-screen md:h-screen md:min-h-[100dvh] flex items-center justify-center overflow-hidden antialiased bg-black select-none"
      >
        ...
        {/* Content Container */}
      <div
        className="relative z-10 w-full px-8 min-[390px]:px-9 sm:px-10 md:px-12 lg:px-14 xl:px-16 max-w-[1520px] mx-auto pt-[86px] min-[390px]:pt-[88px] sm:pt-[90px] md:pt-0 pb-10 md:pb-0 flex flex-col justify-center items-center transition-[padding,max-width] duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]"
      >
        <div
          className="w-full flex flex-col md:flex-row md:justify-between items-start md:items-center gap-9 sm:gap-10 md:gap-8 lg:gap-12 xl:gap-14 py-2 md:py-0 transition-[gap] duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]"
        >
          ...
          >
            ...
            <div className="space-y-6 min-[390px]:space-y-[26px] sm:space-y-5 md:space-y-6 lg:space-y-6.5 xl:space-y-7 text-[13px] min-[360px]:text-[13.5px] min-[375px]:text-[13.8px] min-[390px]:text-[14.2px] sm:text-[14.2px] md:text-[16px] lg:text-[17px] xl:text-[17.5px] text-white/95 font-['Gotham_Regular'] font-normal tracking-normal leading-[1.35] min-[375px]:leading-[1.37] min-[390px]:leading-[1.39] sm:leading-[1.46] md:leading-[1.46] lg:leading-[1.48] text-left antialiased">
              <p>
                An independent post-production practice driven by curiosity, precision, and a deep respect for visual craft. Every project is approached with care and a considered sense of style.
              </p>
      ...
      >
        <div
          className="mx-auto w-full max-w-[1120px] flex-1 px-5 min-[390px]:px-6 sm:px-8 md:px-16 pt-5 min-[390px]:pt-7 sm:pt-10 md:pt-16 lg:pt-20 pb-5 min-[390px]:pb-6 sm:pb-8 md:pb-16 lg:pb-20 flex flex-col justify-center transition-[padding,max-width] duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]"
        >
          ...
          <div className="border-t border-white/20 pt-7 min-[390px]:pt-8 sm:pt-9 md:pt-3.5 lg:pt-4 grid grid-cols-1 md:grid-cols-3 gap-6 min-[390px]:gap-7 sm:gap-8 md:gap-8 lg:gap-10">
            <div className="text-left">
              <h3 
                className="font-['Gotham_Regular'] font-normal text-[19px] min-[375px]:text-[20.5px] min-[390px]:text-[21.5px] sm:text-[23px] md:text-[25px] lg:text-[28px] leading-snug tracking-[-0.02em] mb-1 min-[390px]:mb-1.5 md:mb-1.5 text-white"
                style={{ WebkitTextStroke: "1px rgba(255, 255, 255, 0.85)" }}
              >
                Visit Us
              </h3>
              <p className="font-['Gotham_Regular'] font-normal text-[14.5px] min-[375px]:text-[15.5px] min-[390px]:text-[16px] sm:text-[16.5px] md:text-[17.5px] lg:text-[19px] leading-[1.26] min-[375px]:leading-[1.28] sm:leading-[1.3] md:leading-[1.5] text-white/80 tracking-[-0.01em]">
                Jl. Anggrek B2 No. 25,
                <br />
              ...
              <a
                ...
                className="inline-block mt-0.5 md:mt-0.5 font-['Gotham_Regular'] font-normal text-[14.5px] min-[375px]:text-[15.5px] min-[390px]:text-[16px] sm:text-[16.5px] md:text-[17.5px] lg:text-[19px] text-white/80 hover:text-white transition-colors duration-200 tracking-[-0.01em]"
              >
                Map It
              </a>
            </div>
            ...
            <div className="text-left">
              ...
              <p className="font-['Gotham_Regular'] font-normal text-[14.5px] min-[375px]:text-[15.5px] min-[390px]:text-[16px] sm:text-[16.5px] md:text-[17.5px] lg:text-[19px] leading-[1.26] min-[375px]:leading-[1.28] sm:leading-[1.3] md:leading-[1.5] tracking-[-0.01em]">
                <a
                  href="mailto:hello@siarkannn"
                  className="text-white/80 hover:text-white transition-colors duration-200 inline-block translate-y-[1px] md:translate-y-[2.5px]"
                >
                  hello@siarkannn
                </a>
              </p>
